...
- **[Sol MCP](https://github.com/autonsol/sol-mcp)** - Real-time Solana token risk scoring and momentum signals for pump.fun launches. 4 tools: risk score (0–100) with rug detection, momentum signals (STRONG_BUY to STRONG_SELL), batch analysis. Remote HTTP + x402 pay-per-call ($0.01 USDC on Base).
